...
const PORTFOLIO_LOCALE_MESSAGES = Object.freeze({
  en: {
    ...
    'portfolio.social.instagram.summary': 'MakerDrive visuals and updates',
  ...
  ru: {
    ...
    'portfolio.social.instagram.summary': 'Визуальные материалы и обновления MakerDrive',
  ...
  es: {
    ...
    'portfolio.social.instagram.summary': 'Material visual y actualizaciones de MakerDrive',
