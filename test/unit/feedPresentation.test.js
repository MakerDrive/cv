...
test('publication source links project onto the existing article links contract', () => {
  ...
  const presentation = createPublicationSourceLinkPresentation({ sourceLinks }, 'Project resources');
  ...
  assert.deepEqual(createPublicationSourceLinkPresentation({ sourceLinks: [] }, 'Project resources'), {});
  assert.equal(
